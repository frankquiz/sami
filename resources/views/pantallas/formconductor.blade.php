	...
	<nav class="navbar navbar-default navbar-static-top active" role="navigation" style="margin-bottom: 0">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-6">
                                    ...
                                    <form id="formconductor" role="form" method="POST" action="/pantallas/formconductor">
                                    <form id="formularioconductor" role="form">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        ...
                                        <div class="form-group has-success">
                                           ...
                                           <input style="width:200px;" type="text" class="form-control" id="idireccion_persona" name="idireccion_persona" placeholder="" required>
                                        </div>
                                        
                                        <div class="form-group has-success">
                                            <label class="control-label" for="inputSuccess">Cargo que Ocupa:</label>
                                            <input type="text" class="form-control" id="iconductor_persona" name="iconductor_persona" placeholder="Conductor"required>
                                        </div>
